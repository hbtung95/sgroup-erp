    ...
    <LinearGradient colors={['#1E293B', '#0F172A']} style={styles.container}>
       <BlurView intensity={20} tint="dark" style={styles.header}>
        <View style={{flexDirection: 'row', alignItems: 'center', gap: 12}}>
          <Briefcase color="#A78BFA" size={28} />
          <View>
            <Text variant="h1" color="#F8FAFC" weight="bold">Project Matrix</Text>
            <Text variant="body2" color="#A78BFA">Delivery & Resource Projections</Text>
          </View>
        </View>
      </BlurView>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.matrixContainer}>
          <Text variant="h3" color="#94A3B8" style={{fontFamily: 'monospace', marginBottom: 16}}>MILESTONE_SYNCING</Text>
        </View>
      </ScrollView>
    </LinearGradient>
  );
