...
>
> **📖 Primary Reference**: [`docs/architecture/frontend-architecture.md`](file:///d:/VCT%20PLATFORM/sgroup-erp/docs/architecture/frontend-architecture.md) & [`docs/architecture/dashboard-architecture.md`](file:///d:/VCT%20PLATFORM/sgroup-erp/docs/architecture/dashboard-architecture.md)
...
Design tokens, colors, typography, component catalog, animations → see `arch-ui-ux` SKILL / `docs/architecture/ui-architecture.md`
