...
### Key Conventions
□ Read `.agents/skills/frontend/SKILL.md` — frontend rules
□ Read `.agents/skills/backend-go/SKILL.md` — backend rules
□ Read `.agents/skills/cto/SKILL.md` — quality standards
```
