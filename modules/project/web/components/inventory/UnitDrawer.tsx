    ...
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 z-200 w-full max-w-[500px] bg-white dark:bg-black/80 backdrop-blur-3xl border-l border-slate-200 dark:border-white/5 shadow-[-20px_0_60px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden animate-in slide-in-from-right duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">
        ...
        <div className="relative px-8 pt-8 pb-6 border-b border-white/10 dark:border-white/5 z-10">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-5">
              <div className={`w-16 h-16 rounded-sg-xl flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.2)] ${sCfg.bg.replace('/10', '/20')} border ${sCfg.border} relative group`}>
                <div className={`absolute -inset-4 rounded-sg-2xl border border-${sCfg.color.replace('text-', '')}/30 opacity-50 animate-pulse`} />
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span className={`px-2.5 py-1 rounded-[6px] text-[9px] font-black uppercase tracking-widest shadow-sm ${sCfg.bg} ${sCfg.color} ${sCfg.border}`}>{sCfg.label}</span>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-8 py-6 flex flex-col gap-6 z-10 relative">
          ...
          {/* Price Hero Card */}
          <div className="bg-linear-to-br from-emerald-500/10 to-cyan-500/5 border border-emerald-500/20 rounded-sg-xl p-6 shadow-[0_8px_32px_rgba(16,185,129,0.05)] relative overflow-hidden group">
          ...
          <div className="bg-slate-50 dark:bg-black/30 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-sg-xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.05)]">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col"><p className="text-[10px] font-extrabold text-sg-muted uppercase tracking-wider">Tháp/Block</p><p className="text-[15px] font-black text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-fuchsia-400">{unit.block}</p></div>
              </div>
              <div className="flex items-center gap-4">
          ...
          {(unit.status === 'LOCKED' || unit.status === 'RESERVED' || unit.status === 'DEPOSIT' || unit.status === 'SOLD') && (
            <div className="bg-linear-to-br from-orange-500/10 to-amber-500/5 border border-orange-500/20 rounded-sg-xl p-6 shadow-[0_4px_24px_rgba(249,115,22,0.05)] relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-orange-500/20 blur-2xl" />
